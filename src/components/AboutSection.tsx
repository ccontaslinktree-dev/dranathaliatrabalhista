  ...
  return (
    <section className="py-12 md:py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-primary/10 rounded-full blur-[100px] md:blur-[120px] animate-float"></div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <div className="absolute inset-0 gradient-primary rounded-xl md:rounded-2xl blur-xl md:blur-2xl opacity-30"></div>
              <img 
                src={heroPhoto} 
                alt="Clayverson - Especialista em Tráfego Pago" 
                className="relative w-full h-auto rounded-xl md:rounded-2xl shadow-2xl border border-primary/30 md:border-2"
              />
            </motion.div>
            ...
            >
              ...
              <div className="p-4 md:p-6 glass rounded-lg md:rounded-xl border-glow">
